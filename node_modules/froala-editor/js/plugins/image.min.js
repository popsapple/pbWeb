...
! function(a) {
    ...
    ye.extend(ye.FE.POPUP_TEMPLATES, {
        ...
        imageEditButtons: ["imageReplace", "imageAlign", "imageCaption", "imageRemove", "|", "imageLink", "linkOpen", "linkEdit", "linkRemove", "-", "paragraphStyle", "imageDisplay", "imageAlt", "imageSize"],
        ...
        function C(e) {
            ...
            for (t = 0; t < a.length; t++)
                if (i.push(a[t].getAttribute("src")), ye(a[t]).toggleClass("fr-draggable", p.opts.imageMove), "" === a[t].getAttribute("class") && a[t].removeAttribute("class"), "" === a[t].getAttribute("style") && a[t].removeAttribute("style"), a[t].parentNode && a[t].parentNode.parentNode && p.node.hasClass(a[t].parentNode.parentNode, "fr-img-caption")) {
                    ...
                    n && n.setAttribute("contenteditable", !0)
                } if (o)
        ...
        function A() {
            if (l || function() {
                    pb_selected_img = p.el.querySelectorAll("img");
                    console.log("A");
                    console.log(pb_selected_img);
                    var e;
        ...
        function P(s, e, o, l, f) {
            ...
            t.onload = function() {
                ...
                if (l) {
                    ...
                    e.on("load", O), e.attr("src", s), p.edit.on(), C(!1), p.undo.saveStep(), p.events.disableBlur(), p.$el.blur(), p.events.trigger(a ? "image.replaced" : "image.inserted", [e, f])
                } else e = M(s, o, O), C(!1), p.undo.saveStep(), p.events.disableBlur(), p.$el.blur(), p.events.trigger("image.inserted", [e, f])
            }, t.onerror = function() {
                U(i)
            }, I(p.language.translate("Loading image")), t.src = s
        }
        ...
        function _(e, t) {
            if (void 0 !== e && 0 < e.length) {
                ...
                var a, i = e[0];
                if (null === p.opts.imageUploadURL || p.opts.imageUploadURL == u) return s = i, o = t || g, (l = new FileReader).addEventListener("load", function() {
                    var e = l.result;
        ...
        function K(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (a && a.type && -1 !== a.type.indexOf("image") && 0 <= p.opts.imageAllowedTypes.indexOf(a.type.replace(/image\//g, ""))) {
                    ...
                    return p.opts.iframe && (n += p.$iframe.offset().top, r += p.$iframe.offset().left), p.popups.show("image.insert", r, n), I(), 0 <= p.opts.imageAllowedTypes.indexOf(a.type.replace(/image\//g, "")) ? (oe(!0), _(t.files)) : U(b), e.preventDefault(), e.stopPropagation(), !1
                }
            }
        }
        ...
        function te(e) {
            ...
            g = ye(e), A(), n(), ce(), I(), g.one("load", function() {
                A(), I()
            });
        ...
        function se(e) {
            ...
            p.toolbar.disable(), e && (e.stopPropagation(), e.preventDefault()), p.helpers.isMobile() && (p.events.disableBlur(), p.$el.blur(), p.events.enableBlur()), p.opts.iframe && p.size.syncIframe(), g = ye(this), me(), A(), n(), p.browser.msie || p.selection.clear(), p.helpers.isIOS() && (p.events.disableBlur(), p.$el.blur()), p.button.bulkRefresh(), p.events.trigger("video.hideResizer")
        }
        ...
        return {
            ...
            align: function(e) {
                var t = ve();
                t.removeClass("fr-fir fr-fil"), !p.opts.htmlUntouched && p.opts.useClasses ? "left" == e ? t.addClass("fr-fil") : "right" == e && t.addClass("fr-fir") : ge(t, ue(), e), me(), A(), n(), p.selection.clear()
            },
            ...
            setSize: function(e, t) {
                if (g) {
                    ...
                    var i = /^[\d]+((px)|%)*$/g;
                    g.removeAttr("width").removeAttr("height"), e.match(i) ? g.css("width", e) : g.css("width", ""), t.match(i) ? g.css("height", t) : g.css("height", ""), be() && (g.parent().removeAttr("width").removeAttr("height"), e.match(i) ? g.parent().css("width", e) : g.parent().css("width", ""), t.match(i) ? g.parent().css("height", t) : g.parent().css("height", "")), a.find("input:focus").blur(), B(g)
                }
            },
            toggleCaption: function() {
                var e;
                g && !be() ? ((e = g).parent().is("a") && (e = g.parent()), e.wrap("<span " + (p.browser.mozilla ? "" : 'contenteditable="false"') + 'class="fr-img-caption ' + g.attr("class") + '" style="' + (g.attr("style") ? g.attr("style") + " " : "") + "width: " + g.width() + 'px;" draggable="false"></span>'), e.wrap('<span class="fr-img-wrap"></span>'), e.after('<span class="fr-inner" contenteditable="true">' + ye.FE.START_MARKER + "Image caption" + ye.FE.END_MARKER + "</span>"), g.removeAttr("class").removeAttr("style").removeAttr("width"), oe(!0), p.selection.restore()) : (e = ve(), g.insertAfter(e), g.attr("class", e.attr("class").replace("fr-img-caption", "")).attr("style", e.attr("style")), e.remove(), B(g))
            },
            hasCaption: be,
            exitEdit: oe,
            edit: B
