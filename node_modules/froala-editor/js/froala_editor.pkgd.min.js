...
! function(n) {
    ...
    var s = function(e, t) {
        this.id = ++be.FE.ID, this.opts = be.extend(!0, {}, be.extend({}, s.DEFAULTS, "object" == typeof t && t));
        var n = JSON.stringify(this.opts);
        be.FE.OPTS_MAPPING[n] = be.FE.OPTS_MAPPING[n] || this.id, this.sid = be.FE.OPTS_MAPPING[n], be.FE.SHARED[this.sid] = be.FE.SHARED[this.sid] || {}, this.shared = be.FE.SHARED[this.sid], this.shared.count = (this.shared.count || 0) + 1, this.$oel = be(e), this.$oel.data("froala.editor", this), this.o_doc = e.ownerDocument, this.o_win = "defaultView" in this.o_doc ? this.o_doc.defaultView : this.o_doc.parentWindow;
        var r = be(this.o_win).scrollTop();
        this.$oel.on("froala.doInit", be.proxy(function() {
            ...
            }, this)), this.events.trigger("initializationDelayed")) : (this.load(be.FE.MODULES), this.load(be.FE.PLUGINS), be(this.o_win).scrollTop(r), "undefined" == typeof this.ul && this.destroy(), this.ready = !0, this.events.trigger("initialized"))
        }, this)), this._init()
    };
    s.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, s.MODULES = {}, s.PLUGINS = {}, s.VERSION = "2.8.4", s.INSTANCES = [], s.OPTS_MAPPING = {}, s.SHARED = {}, s.ID = 0, s.prototype._init = function() {
    ...
    }, s.prototype.destroyPB = function() {
        var e = this.html.get();
        this.core.destroyPB(e);
    ...
    if (be.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", be.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", be.FE.LinkRegExTLD = "((" + be.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", be.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + be.FE.LinkRegExCommon + ")", be.FE.LinkRegExWWW = "(www\\." + be.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", be.FE.LinkRegEx = "(" + be.FE.LinkRegExTLD + "|" + be.FE.LinkRegExHTTP + "|" + be.FE.LinkRegExWWW + "|" + be.FE.LinkRegExAuth + ")" + be.FE.LinkRegExEnd, be.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], be.FE.MAIL_REGEX = /.+@.+\..+/i, be.FE.MODULES.helpers = function(a) {
            ...
            function r(e, t) {
                ...
                if (!l.html.isPreformatted(a)) {
                    ...
                    for (var o = "", s = 0; s < i.length; s++) 32 != i.charCodeAt(s) || 0 !== s && 32 != o.charCodeAt(s - 1) ? o += i[s] : o += be.FE.UNICODE_NBSP;
            ...
            return {
                ...
                destroyPB: function(e) {
                    console.log("destroyPB3")
                    a.$el.html("");
                    a.$wp.html("");
                ...
                injectScript: function(e) {
                    if (a.opts.iframe) {
                        /*a.$head.find("script[data-fr-style]").remove(), a.$head.append('<script data-fr-style="true">' + e + "</script>");
                        for (var t = 0; t < a.opts.iframeScriptFiles.length; t++) {
                            var n = be('<script data-fr-style="true" src="' + a.opts.iframeScriptFiles[t] + '">');
                            n.get(0).addEventListener("load", a.size.syncIframe), a.$head.append(n)
                        }*/
                    }
                },
            ...
            return {
                ...
                _middleEnter: function(e) {
                    ...
                    n = a + n + i + be.FE.MARKERS + be.FE.INVISIBLE_SPACE, be(e).replaceWith('<span id="fr-break"></span>');
            ...
            function p(e, t, n) {
                ...
                if (i && "BLOCKQUOTE" == i.tagName) return g(e, i) ? ((r = u.html.defaultTag()) ? be(i).after("<" + r + ">" + be.FE.MARKERS + "<br></" + r + ">") : be(i).after(be.FE.MARKERS + "<br>"), be(e).remove()) : m(e, t, n), !1;
            ...
            function m(e, t, n) {
                ...
                if (null == r) u.html.defaultTag() && e.parentNode === u.el ? be(e).replaceWith("<" + u.html.defaultTag() + ">" + be.FE.MARKERS + "<br></" + u.html.defaultTag() + ">") : (e.nextSibling && !u.node.isBlock(e.nextSibling) || be(e).after("<br>"), be(e).replaceWith("<br>" + be.FE.MARKERS));
                    ...
                    do {
                        var l = i;
                        if (i = i.parentNode, "BLOCKQUOTE" == r.tagName && u.node.isEmpty(l) && !u.node.hasClass(l, "fr-marker") && 0 < be(l).find(e).length && be(l).after(e), ("BLOCKQUOTE" != r.tagName || !g(e, i) && !h(e, i)) && (!t || i != r || t && !u.node.isBlock(r))) {
                    ...
                    if ("BLOCKQUOTE" == r.tagName) {
                        e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" == e.nextSibling.tagName && (be(e.nextSibling).after(e), e.nextSibling && "BR" == e.nextSibling.tagName && be(e.nextSibling).remove());
            ...
            return {
                enter: function(t) {
                    ...
                    u.el.normalize();
                    var r = !1;
                    0 < be(n).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !(t = !1)), be(n).parentsUntil(u.$el, "TD, TH").length && (r = !1), a(n) ? !s(n) || t || r ? p(n, t, r) : u.cursorLists._endEnter(n) : o(n) ? !s(n) || t || r ? function e(t, n, r) {
                        ...
                        if (a && "BLOCKQUOTE" == a.tagName) {
                            if (h(t, a)) return (i = u.html.defaultTag()) ? be(a).before("<" + i + ">" + be.FE.MARKERS + "<br></" + i + ">") : be(a).before(be.FE.MARKERS + "<br>"), be(t).remove(), !1;
            ...
            function o(e) {
                ...
                }, 0) : n != be.FE.KEYCODE.BACKSPACE || u(e) || e.altKey ? n != be.FE.KEYCODE.DELETE || u(e) || e.altKey || e.shiftKey ? n == be.FE.KEYCODE.SPACE ? function(e) {
                    var t = l.selection.element();
                ...
                }(e) : u(e) || !g(e.which) || l.selection.isCollapsed() || e.ctrlKey || e.altKey || l.selection.remove() : l.placeholder.isVisible() ? (l.opts.keepFormatOnDelete || f(), e.preventDefault(), e.stopPropagation()) : ((r = e).preventDefault(), r.stopPropagation(), "" === l.selection.text() ? l.cursor.del() : l.selection.remove(), l.placeholder.refresh()) : l.placeholder.isVisible() ? (l.opts.keepFormatOnDelete || f(), e.preventDefault(), e.stopPropagation()) : function(e) {
                    if (l.selection.isCollapsed())
            ...
            function m(e) {
                var t = e.which;
                if (u(e) || 37 <= t && t <= 40 || !g(t) && t != be.FE.KEYCODE.DELETE && t != be.FE.KEYCODE.BACKSPACE && t != be.FE.KEYCODE.ENTER && t != be.FE.KEYCODE.IME) return !0;
            ...
            function b(e) {
                var t = l.el.childNodes,
                    n = l.html.defaultTag();
                return !(!e.target || e.target === l.el) || (0 === t.length || void(l.$el.outerHeight() - e.offsetY <= 10 ? E(t[t.length - 1]) && (n ? l.$el.append("<" + n + ">" + be.FE.MARKERS + "<br></" + n + ">") : l.$el.append(be.FE.MARKERS + "<br>"), l.selection.restore(), s()) : e.offsetY <= 10 && E(t[0]) && (n ? l.$el.prepend("<" + n + ">" + be.FE.MARKERS + "<br></" + n + ">") : l.$el.prepend(be.FE.MARKERS + "<br>"), l.selection.restore(), s())))
            }
                ...
                _init: function() {
                    ...
                    for (var n, r, i, a = !(f.ul = !0), o = 0, s = 0; s < e.length; s++) {
                        ...
                        if (d === v(h(v("mcVRDoB1BGILD7YFe1BTXBA7B6=="))) || 0 <= d.indexOf(u, d.length - u.length) || C(u)) {
                            if (!((null === (n = l[1]) || new Date(n) < new Date(v("lC4B3B3D4B5A1E1E4I1A1=="))) && 0 < (u || "").length) || C(u)) {
                                f.ul = !1;
                                break
                            }
                ...
                create: function(n, e, t) {
                    if (l.shared.$overlay || (l.shared.$overlay = be('<div class="fr-overlay">').appendTo("body:first")), s = l.shared.$overlay, l.opts.theme && s.addClass(l.opts.theme + "-theme"), !d[n]) {
                        ...
                        d[n] = {
                            ...
                            var t = e.which;
                            return t == be.FE.KEYCODE.ESC ? (c(n), l.accessibility.focusModalButton(r), !1) : !(!be(e.currentTarget).is("input[type=text], textarea") && t != be.FE.KEYCODE.ARROW_UP && t != be.FE.KEYCODE.ARROW_DOWN && !l.keys.isBrowserAction(e) && (e.preventDefault(), e.stopPropagation(), 1))
                        }, !0), c(n, !0)
                    }
                    var i, a, o;
                    return d[n]
            ...
            function i(e) {
                for (var t, n, r = 0; r < be.FE.INSTANCES.length; r++)
            ...
            function o(e) {
            	console.log("opload22");
                if (void 0 !== e && 0 < e.length) {
                    if (!1 === d.events.trigger("file.beforeUpload", [e])) return !1;
                    var t, n = e[0];
                    if (null === d.opts.fileUploadURL || d.opts.fileUploadURL == c) return s = n, (l = new FileReader).addEventListener("load", function() {
            ...
            function S() {
                if (l || function() {
                        ...
                        c.events.on("shared.destroy", function() {
                            ...
                            f && !f.hasClass("fr-uploading") ? se(!0) : f && (S(), he(), w(!1))
                        });
            ...
            function N(e) {
                if (e) return c.$wp && c.events.$on(c.$wp, "scroll", function() {
                    f && c.popups.isVisible("image.edit") && (c.events.disableBlur(), D(f))
                }), !0;
                var t = "";
            ...
            function K(e, t) {
                if (void 0 !== e && 0 < e.length) {
                    ...
                    var n, r = e[0];
                    if (null === c.opts.imageUploadURL || c.opts.imageUploadURL == u) return o = r, s = t || f, (l = new FileReader).addEventListener("load", function() {
                        var e = l.result;
                    ...
                    if (c.drag_support.formdata && (n = c.drag_support.formdata ? new FormData : null), n) {
                        ...
                        c.opts.imageUploadToS3 && (a = c.opts.imageUploadToS3.uploadURL ? c.opts.imageUploadToS3.uploadURL : "https://" + c.opts.imageUploadToS3.region + ".amazonaws.com/" + c.opts.imageUploadToS3.bucket),
                            function(t, n, e, i) {
                                function a() {
                                    var e = be(this);
                                    e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), c.placeholder.refresh(), D(e), S(), w(), c.edit.off(), t.onload = function() {
                                        M.call(t, e)
            ...
            function W(e) {
                ...
                if (t && t.files && t.files.length) {
                    ...
                    if (n && n.type && -1 !== n.type.indexOf("image") && 0 <= c.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, ""))) {
                        ...
                        return c.opts.iframe && (a += c.$iframe.offset().top, i += c.$iframe.offset().left), c.popups.show("image.insert", i, a), w(), 0 <= c.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, "")) ? (se(!0), K(t.files)) : x(E), e.preventDefault(), e.stopPropagation(), !1
                    }
                }
            }
            ...
            function te(e) {
                ...
                f = be(e), S(), a(), he(), w(), f.one("load", function() {
                    S(), w()
                });
            ...
            return {
                _init: function() {
                    ...
                    }, !0)) : c.events.$on(c.$win, "keydown", J), c.events.on("toolbar.esc", function() {
                        if (f) {
                    ...
                    }), N(!0), z(!0), j(!0), V(!0), c.events.on("node.remove", function(e) {
                ...
                insertByURL: function() {
                    var e = c.popups.get("image.insert").find(".fr-image-by-url-layer input");
                    if (0 < e.val().length) {
                        w(), I(c.language.translate("Loading image"));
                        var t = e.val();
                ...
                setSize: function(e, t) {
                    if (f) {
                        ...
                        var r = /^[\d]+((px)|%)*$/g;
                        f.removeAttr("width").removeAttr("height"), e.match(r) ? f.css("width", e) : f.css("width", ""), t.match(r) ? f.css("height", t) : f.css("height", ""), Ee() && (f.parent().removeAttr("width").removeAttr("height"), e.match(r) ? f.parent().css("width", e) : f.parent().css("width", ""), t.match(r) ? f.parent().css("height", t) : f.parent().css("height", "")), n.find("input:focus").blur(), D(f)
                    }
                },
                toggleCaption: function() {
                    var e;
                    f && !Ee() ? ((e = f).parent().is("a") && (e = f.parent()), e.wrap("<span " + (c.browser.mozilla ? "" : 'contenteditable="false"') + 'class="fr-img-caption ' + f.attr("class") + '" style="' + (f.attr("style") ? f.attr("style") + " " : "") + "width: " + f.width() + 'px;" draggable="false"></span>'), e.wrap('<span class="fr-img-wrap"></span>'), e.after('<span class="fr-inner" contenteditable="true">' + be.FE.START_MARKER + "Image caption" + be.FE.END_MARKER + "</span>"), f.removeAttr("class").removeAttr("style").removeAttr("width"), se(!0), c.selection.restore()) : (e = ve(), f.insertAfter(e), f.attr("class", e.attr("class").replace("fr-img-caption", "")).attr("style", e.attr("style")), e.remove(), D(f))
                },
                hasCaption: Ee,
                exitEdit: se,
                edit: D
    ...
    be.FE.DEFAULTS.imageInsertButtons.push("imageManager"), be.FE.RegisterCommand("imageManager", {
        ...
        function c(e, t, n) {
            ...
            if ("" === f.opts.linkAutoPrefix || new RegExp("^(" + be.FE.LinkProtocols.join("|") + "):.", "i").test(e) || /^data:image.*/i.test(e) || /^(https?:|ftps?:|file:|)\/\//i.test(e) || /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) || ["/", "{", "[", "#", "(", "."].indexOf((e || "")[0]) < 0 && (e = f.opts.linkAutoPrefix + f.helpers.sanitizeURL(e)), e = f.helpers.sanitizeURL(e), f.opts.linkAlwaysBlank && (n.target = "_blank"), f.opts.linkAlwaysNoFollow && (n.rel = "nofollow"), "_blank" == n.target ? (f.opts.linkNoOpener && (n.rel ? n.rel += " noopener" : n.rel = "noopener"), f.opts.linkNoReferrer && (n.rel ? n.rel += " noreferrer" : n.rel = "noreferrer")) : null == n.target && (n.rel ? n.rel = n.rel.replace(/noopener/, "").replace(/noreferrer/, "") : n.rel = null), t = t || "", e === f.opts.linkAutoPrefix) return f.popups.get("link.insert").find('input[name="href"]').addClass("fr-error"), f.events.trigger("link.bad", [i]), !1;
            var a, o = p();
            if (o) {
        ...
        NAME: "magic"
    }), be.FE.PLUGINS.print = function(i) {
        return {
            run: function() {
                var e = i.$el.html(),
                    t = null;
        ...
        return {
            _init: function() {
                if (!o.$wp) return !1;
                o.opts.iframe && o.$el.parent("html").find("head").append('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.4.0/css/font-awesome.min.css">'), o.popups.onShow("image.edit", i), o.events.on("mouseup", r), o.helpers.isMobile() && o.events.$on(be(o.o_doc), "selectionchange", r), o.events.on("blur", i), o.events.on("keyup", r), o.events.on("keydown", function() {
                    setTimeout(function() {
                        r()
                    }, 0)
                })
        ...
        function D(e, t, n, r) {
            return e.pageX = t, e.pageY = t, w.call(this, e), e.pageX = e.pageX + n * Math.floor(Math.pow(1.1, r)), e.pageY = e.pageY + n * Math.floor(Math.pow(1.1, r)), O.call(this, e), I.call(this, e), ++r
        }
        ...
        function F() {
            p || function() {
                ...
                if (f.shared.$video_resizer ? (p = f.shared.$video_resizer, s = f.shared.$vid_overlay, f.events.on("destroy", function() {
                    ...
                    e = p.get(0).ownerDocument, f.events.$on(p, f._mousedown, ".fr-handler", w), f.events.$on(be(e), f._mousemove, O), f.events.$on(be(e.defaultView || e.parentWindow), f._mouseup, I), f.events.$on(s, "mouseleave", I);
                    var r = 1,
                        i = null,
                        a = 0;
        ...
        function U(e) {
            ...
            if (void 0 !== e && 0 < e.length) {
                ...
                var t, n = e[0];
                if (null === f.opts.videoUploadURL || f.opts.videoUploadURL == d) return s = n, (l = new FileReader).addEventListener("load", function() {
                    l.result;
                ...
                /*if (f.drag_support.formdata && (t = f.drag_support.formdata ? new FormData : null), t) {
                    ...
                    a.onload = function() {
                        _.call(a, u)
                    }, a.onerror = L, a.upload.onprogress = x, a.onabort = N, C(), f.events.disableBlur(), f.edit.off(), f.events.enableBlur();
        ...
        return i[1] = "Video cannot be loaded from the passed link.", i[l] = "No link in upload response.", i[h] = "Error during file upload.", i[g] = "Parsing response failed.", i[m] = "File is too large.", i[v] = "Video file type is invalid.", i[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", f.shared.vid_exit_flag = !1, {
            _init: function() {
                f.events.on("drop", P, !0), f.events.on("mousedown window.mousedown", e), f.events.on("window.touchmove", B), f.events.on("mouseup window.mouseup", $), f.events.on("commands.mousedown", function(e) {
